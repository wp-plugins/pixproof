...
1. Manually (default) - you have to upload a ZIP archive to each gallery.
1. Automatically - the client can download the selected images in a ZIP archive (automatically generated by the server).
